...
import { rvmExpenseListColumns } from '../../table/columns/columns'
import PrintModal from '../../models/ui/PrintModal'
import RvmExpenseView from '../printViews/RvmExpenseView'
import { useReactToPrint } from 'react-to-print'
import { dbDateInputFormatter } from '../../../util/formatter'
...
function RvmExpenses({ data, description }) {
    // MODAL HANDLER
    ...
    return (
        <>
            ...
            <div>
                ...
                <ExpenseTable tableData={filteredData} column={rvmExpenseListColumns} collapsible_col={['points', 'method']} />
            </div>
        </>
    )
}

export default RvmExpenses