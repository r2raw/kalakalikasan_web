...
const AllExpensesPrintView = forwardRef(function AllExpensesPrintView({ filteredData, dateRange, totalExpense, description }, ref) {
    return (
            ...
            <table className='w-full'>
                ...
                <tbody>
                    {filteredData.map(item => {
                        ...
                        const fullname = item.name || 'N/A'
                        return (
                            <tr key={item.id} className='even:bg-pastel_green'>
                                <td>{item.type}</td>
                                <td>{titleCase(item.method)}</td>
                                <td>{titleCase(fullname)}</td>
...
export default AllExpensesPrintView