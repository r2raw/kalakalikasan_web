...
function CustomTextArea({ placeholderName, val, maxVal, ...props }) {
    ...
    return (
        <div className='relative'>
            ...
            <span className=' pointer-events-none absolute left-0 scale-75 -top-[30px]  peer-placeholder-shown:top-[10px]  duration-300   text-light_font'>{placeholderName}</span>
            <span className='absolute bottom-2 right-2'>500/500</span>
        </div>
    )
}
